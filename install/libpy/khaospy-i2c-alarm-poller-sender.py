...
"""
khaospy-i2c-alarm-poller-sender

By Karl "khaos" Hoskin 2015-10-27 , 2015-12-27
...
Thus some other process can listen to these ports.

TODO still need to get the PORT it pushes data to from the config.
Saying that I can't see more than one of these running on a pi-host.
